...
| `daos_force_format` | `_daos_force_reformat` | 1 |
| `use_pacemaker` | `ha_use_pacemaker` | 1 |
| `wait_smbd_fail` | `wait_smbd_fail_msg` | 1 |
| `starrocks_save_image` | `starrocks_acr_image` | 1 |
...
- **attribute access** — `daos_mount_check.stat.exists` looked like `stat` and `exists`.
