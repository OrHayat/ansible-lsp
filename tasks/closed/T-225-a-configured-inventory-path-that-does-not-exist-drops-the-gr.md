...
Measured on the reference tree (`acme/app/ansible`, commit `0000000a`, 768 files),
`scan` on 2026-09-04:
...
(`lustre_build_output_dir:841`, `container_temp_dir:345`, `vendor_submodule_path:587`,
...
- [x] the reference tree, as checked out, reports the with-file count (197 at `0000000a`)
